...
$template = preg_replace('#<bot name="([^"]*)"/>#ie', "\$convoArr['bot_properties']['$1']", $template);
			...
			$i++;
			$find[$i]='#<bot name="([^"]*)"/>#i';
			$replace[$i]='\'.call_user_func_array(\'get_convo_var\',array(&$convoArr,\'bot_properties\',\'$1\')).\'';
			...
			$i++;
			$find[$i]='#<star index="([^"]*?)"/>#i';
			$replace[$i]='\'.call_user_func_array(\'get_convo_var\',array(&$convoArr,\'star\',\'\',\'$1\')).\'';
			...
			$i++;
			$find[$i]='#<set name="([^"]*)">#i';
			$replace[$i]='\'.call_user_func_array(\'set_simple\',array(&$convoArr,\'$1\',\'';		
